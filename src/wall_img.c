...
/*   Updated: 2021/04/06 19:17:33 by xchalle          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	wall(t_h *h)
{
	if (!(h->img2.img = mlx_xpm_file_to_image(h->img.mlx,
...
int	wall_we(t_h *h)
{
	if (!(h->img3.img = mlx_xpm_file_to_image(h->img.mlx,
...
int	wall_so(t_h *h)
{
	if (!(h->img4.img = mlx_xpm_file_to_image(h->img.mlx,
...
int	wall_s(t_h *h)
{
	if (!(h->img6.img = mlx_xpm_file_to_image(h->img.mlx,
...
int	wall_no(t_h *h)
{
	if (!(h->img5.img = mlx_xpm_file_to_image(h->img.mlx,
